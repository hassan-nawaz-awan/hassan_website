      ...
      <div className="container-content grid gap-10 py-24 lg:grid-cols-[200px_1fr] lg:gap-16">
        ...
        <div className="max-w-4xl">
          ...
          <div className="grid gap-10 sm:grid-cols-[200px_1fr] sm:gap-12">
            ...
            >
              <div className="aspect-[4/5] w-full max-w-[240px] overflow-hidden rounded-2xl border border-hairline bg-surface shadow-card dark:border-hairline-dark dark:bg-surface-dark">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <motion.div
                ...
                className="rounded-xl border border-hairline bg-surface p-6 shadow-sm dark:border-hairline-dark dark:bg-surface-dark"
              >
          ...
          <motion.div
            ...
            className="mt-10 rounded-xl border-l-4 border-accent bg-accent/10 p-6 dark:border-accent-dark dark:bg-accent-dark/10"
          >
